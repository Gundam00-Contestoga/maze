...
public class GameManager : MonoBehaviour
{
    ...
    public void StartMaze()
    {
        ...
        /*
            O Time.timeScale � uma propriedade do Unity que controla a velocidade do tempo do jogo. 
            � muito �til para pausar o jogo ou desacelerar o tempo.
            Time.timeScale = 1: O tempo do jogo est� em velocidade normal.
            Time.timeScale = 0: O jogo est� pausado (todas as atualiza��es de Update, anima��es e f�sica param).
            Time.timeScale < 1: O jogo � desacelerado (ex.: 0.5 significa que o tempo passa � metade da velocidade normal).
        */
        //Game is running
        //N�o preciso mais disso. Vou adiministrar na TimeManager
        //Time.timeScale = 1;
